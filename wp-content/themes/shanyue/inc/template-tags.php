...
if ( ! function_exists( 'shanyue_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function shanyue_posted_on() {
...
if ( ! function_exists( 'shanyue_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'shanyue_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function shanyue_entry_footer() {
...
if ( ! function_exists( 'shanyue_techs_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function shanyue_techs_footer() {
...
if ( ! function_exists( 'shanyue_post_thumbnail' ) ) :
	/**
...
if ( ! function_exists( 'shanyue_search_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function shanyue_search_footer() {
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type() ) {
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ' ', 'list item separator', 'shanyue' ) );
