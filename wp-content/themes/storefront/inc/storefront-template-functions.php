...
if ( ! function_exists( 'storefront_header_top' ) ) {
	...
	function storefront_header_top() {
        ...
        <div class="top-info row">
            <div class="col col-sm-4 col-8 welcome"><?php echo get_theme_mod( 'storefront_header_welcome' ); ?></div>
            <div class="col col-sm-8 col-4 contact">
                <div class="email">
					<?php
                ...
                <div class="wechat">
					...
					if ( $storefront_header_wechat_value != '' ) {
                        ...
                        <a>
                            ...
                            <span><?php echo __( 'Wechat', 'storefront' ) ?></span>
                ...
                <div class="facebook">
					...
					if ( $storefront_header_facebook_value != '' ) {
                        ...
                        <a href="<?php echo $storefront_header_facebook_value ?>" target="_blank">
                            ...
                            <span><?php echo __( 'Facebook', 'storefront' ) ?></span></a>
					<?php } ?>
                </div>
                ...
                <div class="etsy">
					...
					if ( $storefront_header_etsy_value != '' ) {
						?>
                        <a href="<?php echo $storefront_header_etsy_value ?>"
                           title="<?php echo __( 'Purchase on Etsy', 'storefront' ) ?>" target="_blank">
                            <i class="fa fa-etsy"></i>
                            <span><?php echo __( 'Etsy', 'storefront' ) ?></span></a>
					<?php } ?>
                </div>
            </div>
        </div>
...
if ( ! function_exists( 'storefront_site_user_login' ) ) {
	/**
	 * Display the page header
	 *
	 * @since 1.0.0
	 */
	function storefront_site_user_login() {
		?>
        <div class="site-user-login">
			<?php
			if ( ! is_user_logged_in() ) {
				$link1 = '<a href="' . esc_url( site_url( 'my-account', 'login' ) ) . '">' . __( 'Login' ) . '</a>';
				if ( get_option( 'users_can_register' ) ) {
					$link2 = '<a href="' . esc_url( wp_registration_url() ) . '">' . __( 'Register' ) . '</a>';
				} else {
					$link2 = null;
				}
			} else {
				$link1 = '<a href="' . esc_url( site_url( 'my-account', 'login' ) ) . '">' . __( 'My Account' ) . '</a>';
				$link2 = '<a href="' . esc_url( wp_logout_url( site_url( 'my-account', 'login' ) ) ) . '">' . __( 'Log out' ) . '</a>';
			}
			echo $link1 . ( $link2 ? ' / ' . $link2 : '' );
			?>
        </div><!-- .entry-header -->
		<?php
	}
...
if ( ! function_exists( 'storefront_site_logo_wrapper' ) ) {
	/**
	 * The primary navigation wrapper
	 */
	function storefront_site_logo_wrapper() {
		echo '<div class="storefront-site-logo-wrapper">';
	}
}

if ( ! function_exists( 'storefront_site_logo_wrapper_close' ) ) {
	/**
	 * The primary navigation wrapper
	 */
	function storefront_site_logo_wrapper_close() {
		echo '</div>';
	}
}

if ( ! function_exists( 'storefront_site_search_wrapper' ) ) {
	/**
	 * The primary navigation wrapper
	 */
	function storefront_site_search_wrapper() {
		echo '<div class="storefront-site-search-wrapper">';
	}
}

if ( ! function_exists( 'storefront_site_search_wrapper_close' ) ) {
	/**
	 * The primary navigation wrapper
	 */
	function storefront_site_search_wrapper_close() {
		echo '</div>';
	}
}
